...
__all__ = ['initial_voxelize', 'point_to_voxel', 'voxel_to_point', 'project_lidar_to_image']
...
# # TEXT_PROMPT = "shoreline. tree. concreteplatform. water."

# ## real-world
# # TEXT_PROMPT = "grass-shore. tree. green-floating. water."
# # TEXT_PROMPT = "grassyshoreline. treetrunks-abovewater. floating-greenpatches. open-watersurface."
# # TEXT_PROMPT = "shoreline. wood. floating-greenmud. clean-watersurface."
...
#     text = TEXT_PROMPT
#     image_source, image = load_image(image)  # Convert OpenCV image to format for model, around 0.08s
#     sam2_predictor.set_image(image_source)   # around 0.01s
#     start_t_gd = time.time()
...
#     )
#     end_t_gd = time.time()
#     print(f"grounding dino prediction done in {end_t_gd - start_t_gd:.2f} seconds wall time.")
#     print("labels: ", labels)
...
#     )
#     end_t_s = time.time()
#     print(f"sam2 prediction done in {end_t_s - start_t_s:.2f} seconds wall time.")
